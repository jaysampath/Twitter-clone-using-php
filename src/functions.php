<?php 
   ...
   $link= mysqli_connect("sdb-e.hosting.stackcp.net","twitter_users-31383349b4","Jayasampath@200","twitter_users-31383349b4");
   ...
   function displayTweets($type) {
       ...
       if(mysqli_num_rows($result)==0){
           echo "There are no tweets do display";
       }else{
  ...
  <button type="submit" class="btn btn-primary">Search Tweets</button>
   ...
   function displayTweetBox(){
       ...
       if($_SESSION['id']>0){
          ...
          echo '<div id = "tweetSuccess" class="alert alert-success">Your tweet posted successfully </div> 
